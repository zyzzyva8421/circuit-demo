...
private:
    ...
    // Draw helpers
    QPointF getPinCoordinates(ogdf::node n, const std::string& pinName);
    void drawEdges();
    void drawInstance(ogdf::node n);
    void drawInstance(const GraphNodeData& data, double x, double y, double w, double h);
